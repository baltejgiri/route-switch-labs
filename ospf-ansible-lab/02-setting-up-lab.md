...
## Creating a new lab
Start with creating a new lab in the eve-ng. Add 4 cisco routers and 3 cisco switches. Connect all network devices following the network design ![Network design](imagesSPF-Multiarea-logical-design.png). Start all network nodes, verify all nodes can start.
...
![Network Bridge from Eve-ng to Virtual machine](imagescreenshot 2025-11-21 161243.png)
